...
import classNames from "@/utils/add-classname";

const navigation = [
  { name: "Encontrar Vagas", href: "#", current: true },
  { name: "Minhas Vagas", href: "#", current: false },
];
                      ...
                      <a
                        className={classNames(
                          item.current
                            ...
                            : "text-gray-400 font-light hover:bg-gray-700 hover:text-white",
