...
import { Apply, State } from '@/server/apply/domain/apply.entity';
import { CandidateMapper } from '@/server/candidate/infra/repository/mongo/candidate.mapper';
import { CompanyMapper } from '@/company/infra/repository/mongo/company.mapper';
import { JobAdMapper } from '@/server/job/infra/repository/mongo/job-ad.mapper';
