...
import { TruncateAfter } from '@/server/@shared/decorator';
import {
	GreatherThanOrEqual,
	LessThanOrEqual,
} from '@/server/@shared/decorator/lte-gte.decorator';
import { PaginationInterface } from '@/server/@shared/repository/pagination-interface';
import { Meta, ToMeta } from '@/server/@shared/repository/presenter/meta.dto';
import { Status } from '@/server/job/domain/entity/job.entity';
import { Filters } from '@/server/job/domain/filters/filters';
